...
import { Filter, MapPin, SlidersHorizontal, Plus, Search } from "lucide-react";
...
export function LocationPage() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      // Fetch PGs with aggregated ratings from your DB view
  ...
  const filtered = useMemo(() => {
    ...
    // Budget logic (Relies on string matching for now per your previous snippet)
