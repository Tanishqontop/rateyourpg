...
export function LocationPage() {
  ...
  const [pgs, setPgs] = useState<any[]>([]); // Changed to any[] to support view columns
  ...
  useEffect(() => {
    void (async () => {
      ...
      // FETCH FROM VIEW: Now includes average_rating and total_reviews
  ...
  const filtered = useMemo(() => {
    ...
    return list;
  }, [pgs, q, sort, budget, gender, amenityFilter]);
    ...
    <>
      ...
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
        ...
        <p className="mt-2 max-w-2xl text-stone-600">
          Compare food, safety, and value scores — then leave a review to help the next student.
        </p>
